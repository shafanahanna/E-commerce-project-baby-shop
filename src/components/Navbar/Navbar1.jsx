...
//               <Nav.Link style={{fontSize:'1.2em'}} className='m-1' onClick={handleLogout}><HiUserCircle /></Nav.Link>
//               </>
//              ) :(
//               <>
//               <Nav.Link style={{fontSize:'1.2em'}} className='m-1' onClick={()=>{navigate('/login')}}><FaUser/></Nav.Link>
//               </>
//              )}
//              <p className='m-1'>|</p>
//              <Nav.Link className='m-1 mx-' onClick={()=>{navigate('/cart')}}>
