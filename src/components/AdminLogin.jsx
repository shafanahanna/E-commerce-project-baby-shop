...
toast.success('login sucessfully')
 ...
 <div  className='shadow p-3 mb-5 bg-white rounded m-3   ' style={{width:"25rem", height:"55vh", margin:"auto" ,marginTop:"10%",border:'2px solid black'}}>  
 <h1 className='text-muted'>ADMIN LOGIN</h1>
