      ...
      <div className="container text-center text-md-left w-100">
        <div className="row text-center text-md-left">
          <div className="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
            ...
            <p>
                <span style={{color:'deeppink'}}>Baby</span><span style={{color:'lightblue'}}>Que</span> is a leading baby care products with clothes,toys and nutritions .We focus on babies needs and comfort.Get shopping with us.ThankYou!
            </p>
          </div>
          <div className="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
            <h5 className="text-uppercase mb-4 font-weight-bold">Products</h5>
            <p>
              <span className="text-white" style={{ textDecoration: 'none' }}>Clothes</span>
            </p>
            
            <p>
              <span className="text-white" style={{ textDecoration: 'none' }}>Toys</span>
            </p>
            <p>
              <span className="text-white" style={{ textDecoration: 'none' }}>Nutrition</span>
            </p>
          </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-12">
            <p className="text-center">
              Copyright &copy; 2023 All rights reserved by BabyQue.
            </p>
          </div>
        </div>
      </div>
